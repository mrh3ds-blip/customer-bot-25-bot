...
const DETAILS_RAW = "1) دسته‌بندی‌ها: مثل فیلم ایرانی، سریال خارجی، انیمیشن، آموزشی، عکس\n2) جستجوی فیلم/عکس بله\n4) آ\n5) آیا کاربران بتوانند درخواست فیلم/محتوای جدید بدهند؟ بله/خیر\n6) آیا محتوا رایگان است یا پولی/VIP؟\n7) نمونه محتوا یا توضیح ساختار آرشیو را بفرست.\n\nمثال:\nدسته‌ها: فیلم ایرانی، سریال خارجی، انیمیشن\nقفل کانال: @mychannel\nحذف خودکار: 60 ثانیه\nجستجو: بله\nدرخواست محتوا: بله";
const DETAIL_LINES = [
  "1) دسته‌بندی‌ها: مثل فیلم ایرانی، سریال خارجی، انیمیشن، آموزشی، عکس",
  "2) جستجوی فیلم/عکس بله",
  "4) آ",
  "5) آیا کاربران بتوانند درخواست فیلم/محتوای جدید بدهند؟ بله/خیر",
  "6) آیا محتوا رایگان است یا پولی/VIP؟",
...
function defaultSettings(): Settings {
  return {
    ...
    items: defaultItems(),
    mediaItems: [],
    mediaCategories: TEMPLATE_CODE === "MEDIA_GALLERY" ? defaultItems().map((x) => x.title) : [],
